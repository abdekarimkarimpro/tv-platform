  ...
  return (
        <div className="flex min-h-screen items-center justify-center bg-gray-100">
              <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-md">
                      <h2 className="mb-6 text-center text-2xl font-bold">Create an Account</h2>h2>
                {error && <p className="mb-4 text-center text-red-500">{error}</p>p>}
                      <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                            <label htmlFor="role" className="block text-sm font-medium text-gray-700">Register as</label>label>
                      ...
                      <p className="mt-4 text-center text-sm">
                                Already have an account? <Link href="/login" className="text-blue-600 hover:underline">Log in</Link>Link>
      </p>p>
              </div>div>
        </div>div>
      );
